...
function humanChoice(yourChoice){
    ...
    botChoice = chooseRandomClass(number);
...
function frontEnd(result,humanChoice,botChoice)
{
    ...
    humanDiv.innerHTML = "<img src='" + imageData[humanChoice] + "' style='box-shadow: 0px 0px 26px 11px rgba(115,107,191,1);'>";
    botDiv.innerHTML = "<img src='" + imageData[botChoice] + "' style='box-shadow: 0px 0px 26px 11px rgba(115,107,191,1);'>";
